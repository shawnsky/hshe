...
public class Comparator {
	 ...
	 */
	public static boolean isOutputTheSame(String standardOutputFilePath,
	 ...
	 */
	private static boolean isFileOutputTheSame(LineIterator stdFileItr, LineIterator fileItr) {
		try {
	 ...
	 */
	private static boolean isLineOutputTheSame(String stdLine, String line) {
	 ...
	 */
	private static boolean isLineEmpty(String line, int startIndex) {
